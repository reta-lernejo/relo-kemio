...
function konsultu(prologo,programo) {
    ...
    return new Promise((resolve, reject) => {
        ...
        seanco.consult(programo, {
            success: () => {
                console.info(`programo sukcese ŝarĝiĝis`);
                resolve(seanco) // redonu la seancon por la sekva paŝo
            }, 
            error: (err) => {
...
function demandu(seanco, demando) {
    return new Promise((resolve, reject) => {
        seanco.query(demando, {
            success: () => {
                console.info(`demando '${demando}' akceptiĝis`);
                resolve(seanco) // redonu la seancon por la sekva paŝo
            },
            error: (err) => {
...
function sekva_respondo(seanco) {
    return new Promise((resolve, reject) => {
        seanco.answer({
            success: (respondo) => {
                console.info("respondo: "+pl.format_answer(respondo));
                resolve(respondo)
            },
            fail: () => {
                consolo.info("nea respondo");
                resolve(null) // ne (plu) troviĝas respondoj
            },
            error: (err) => {
